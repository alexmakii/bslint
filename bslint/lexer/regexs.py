...
REGEX_LIST = [
    ...
    [r"/=", const.OPERATOR, const.EQUALS, const.NO_INDENTATION],
    [r"\\=", const.OPERATOR, const.EQUALS, const.NO_INDENTATION],
    ["<<=", const.OPERATOR, const.EQUALS, const.NO_INDENTATION],
    [">>=", const.OPERATOR, const.EQUALS, const.NO_INDENTATION],
    ...
    [r"\(", const.OPEN_PARENTHESIS, const.OPEN_PARENTHESIS, const.NO_INDENTATION],
    [r"\)", const.CLOSE_PARENTHESIS, const.CLOSE_PARENTHESIS, const.NO_INDENTATION],
    [r"\[", const.OPEN_SQUARE_BRACKET, const.OPEN_SQUARE_BRACKET, const.INCREMENT_INDENTATION],
    [r"\]", const.CLOSE_SQUARE_BRACKET, const.CLOSE_SQUARE_BRACKET, const.DECREMENT_INDENTATION],
    ...
    [r"(GETLASTRUNCOMPILEERROR)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(GETLASTRUNRUNTIMEERROR)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(GETGLOBALAA)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    ...
    [r"(Tr)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Val)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Stringi)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Stri)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Str)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Right)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Len)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Left)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Instr)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Chr)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Asc)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(LCase)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Ucase)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(FormatJson)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(ParseJson)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(RunGarbageCollector)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(strtoi)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(FormatDrive)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(CreateDirectory)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(DeleteDirectory)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(DeleteFile)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(MatchFiles)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(MoveFile)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(CopyFile)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(WriteAsciiFile)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(ReadAsciiFile)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(RebootSystem)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(UpTime)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(GetInterface)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    ...
    [r"(Run)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Box)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(FindMemberFunction)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Rnd)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(Mid)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    ...
    [r"(MOD)\b", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    ...
    [r"(POS)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    ...
    [r"(TAB)\b", const.KEYWORD, const.BUILT_IN_FUNCTION, const.NO_INDENTATION],
    [r"(ASSERTTRUE)\b", const.ASSERT, const.ASSERT, const.NO_INDENTATION],
    [r"(ASSERTFALSE)\b", const.ASSERT, const.ASSERT, const.NO_INDENTATION],
    [r"(ASSERTEQUAL)\b", const.ASSERT, const.ASSERT, const.NO_INDENTATION],
